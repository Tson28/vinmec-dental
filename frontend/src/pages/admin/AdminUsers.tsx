  ...
  const columns = [
    {
      ...
      render: (u: User) => (
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 rounded-full bg-gradient-dental flex items-center justify-center text-white text-xs font-bold">
            {u.name?.charAt(0)}
          </div>
    ...
    { key: "email", header: "Email" },
    {
      ...
      render: (u: User) => (
        <span
          className={`badge ${u.role === "admin" ? "badge-red" : u.role === "doctor" ? "badge-blue" : "badge-green"}`}
        >
          {u.role}
        </span>
      ),
      ...
      render: (u: User) => (
        <div className="flex gap-2">
          <button
            ...
            className="text-xs text-dental-600 hover:text-dental-700 font-medium"
          >
            Edit
          </button>
          <button
